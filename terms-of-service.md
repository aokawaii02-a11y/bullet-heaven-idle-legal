...
* Copy, modify, reverse-engineer, decompile, or create derivative works of the App, except where permitted by applicable law.
* Use the App for any commercial purpose without our prior written consent.
* Use cheats, automation tools, exploits, or unauthorized third-party software to gain an unfair advantage or alter the App's intended behavior.
* Redistribute, sell, rent, or sublicense the App or any part of it.
...
The App may offer optional rewarded video advertisements in exchange for in-game rewards, served through third-party advertising networks (see our [Privacy Policy](./PRIVACY_POLICY.md) for details). Ad availability is not guaranteed at all times and may depend on your region, connectivity, and third-party ad inventory.

## 4\. Your Data

All game progress is stored locally on your device. We are not responsible for any loss of progress resulting from uninstalling the App, using the "Delete Save Data" feature, device failure, or similar events outside our control. See our [Privacy Policy](./PRIVACY_POLICY.md) for details on how data is handled.
